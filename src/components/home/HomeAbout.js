      ...
      <div className="container">
          ...
          <div className="row padding-top50">
            <div className="col-sm-4 online-RTI-section">
                <img className="online-rti-icon" src="assets/images/icon1.png" alt="" />
            ...
            <div className="col-sm-4 online-RTI-section">
                <img className="online-rti-icon" src="assets/images/icon2.png" alt="" />
            ...
            <div className="col-sm-4 online-RTI-section">
                <img className="online-rti-icon" src="assets/images/icon3.png" alt="" />
